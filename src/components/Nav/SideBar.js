                ...
                <ul className="relative px-1">
                  ...
                  <li className="relative" id="sidenavXxEx4">
                    ...
                    <ul className="relative accordion-collapse collapse" id="collapseSidenavXxEx4" aria-labelledby="sidenavXxEx4" data-bs-parent="#sidenavSecExample">
                      ...
                      <li className="relative">
                        <Link to="/add-user" className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">Add Users</Link>
                      </li>
                    </ul>
                  </li>
                  <li className="relative" id="sidenavSecEx2">
                    ...
                    <ul className="relative accordion-collapse collapse" id="collapseSidenavSecEx2" aria-labelledby="sidenavSecEx2" data-bs-parent="#sidenavSecExample">
                      <li className="relative">
                        <Link to="/account" className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">Account</Link>
                      </li>
                    </ul>
                  </li>
                  <li className="relative" id="sidenavSecEx1">
                    ...
                    <ul className="relative accordion-collapse collapse" id="collapseSidenavSecEx1" aria-labelledby="sidenavSecEx1" data-bs-parent="#sidenavSecExample">
                      <li className="relative">
                        <Link to="#!" className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">Uploads</Link>
                      </li>
                    </ul>
                  </li>
                  <li className="relative" id="sidenavSecEx3">
                    ...
                    <ul className="relative accordion-collapse collapse" id="collapseSidenavSecEx3" aria-labelledby="sidenavSecEx3" data-bs-parent="#sidenavSecExample">
                      <li className="relative">
                        <Link to="/" className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">Manage Employees</Link>
                      </li>
                    </ul>
                  </li>
                  <li className="relative">
